...
> **Sample on GitHub** · `CHN50_1m.csv` (55,440 rows, `2026-06-26` -> `2026-09-02`, 3.97 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/chn50)** — **2,681,069** `1m` rows, **11 timeframes**, `2017-07-17` -> `2026-09-02`.
